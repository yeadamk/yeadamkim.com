...
const about =
  "I'm a fourth-year Mathematics of Computation major at UCLA.\n\nCurrently looking for SWE New Grad positions for 2025! I'm particularly interested in full-stack or back-end development, delivering products, features, and optimizations directly to end-users.\n\nI love to work on personal projects on the side, tinker around with my linux terminal, and keep up with the latest tech videos on YouTube. With a strong foundation in mathematics and computer science,  I’m eager to tackle real-world challenges and bring my passion in software engineering to create meaningful solutions that benefit people around the world.\n\nApart from academics, I also enjoy playing various sports (e.g. soccer, badminton, volleyball, and more), and have great interest jazz piano.";

const projects =
  "Every day, my passion in software engineering is fueled by working on personal projects. I really like to bring my creative ideas to life. I find joy in translating my acquired knowledge to a fully functioning program and in the process of learning while working on my personal projects.\n\nFrom making python scripts to automate mundane tasks to building fully scalable, dynamic web applications, I have developed a diverse range of projects in languages such as C, C++, JavaScript, and Python.";
