...
const projects =
  "Every day, my passion in software engineering is fueled by working on personal projects. I like to learn by building programs and libraries from sratch, like implementing stdlib functions in C or making python/bash scripts for automating mundane tasks. Although my experimental projects are mostly kept private, you can definitely check out my public repos on my GitHub!\n\nThank you for visiting!";
